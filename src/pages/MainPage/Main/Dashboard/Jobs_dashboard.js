...
import IMAGEROUTER from '../../../../routes/ImgRouters.js';
          ...
          <div className="page-header">
            <div className="row">
              <div className="col-sm-12">
                <marquee behavior="scroll" direction="right" style={{ backgroundColor: "black", color: "white" }}>The data persent here is only for display purpose...!</marquee>
                        ...
                        <tr>
                          ...
                          <td>
                            <h2 className="table-avatar">
                              <Link to="/app/profile/employee-profile/profile" className="avatar"><img src={IMAGEROUTER.Avatar} /></Link>
